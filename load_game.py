...
def list_logs():
    ...
    print("\nTo list checkpoints in a log file, use: python load_game.py --log <log_path>")
    print("To load a checkpoint, use: python load_game.py --log <log_path> [--checkpoint <index>]")
...
def list_checkpoints(log_path):
    ...
    print("\nTo load a checkpoint, use: python load_game.py --log <log_path> --checkpoint <index>")
